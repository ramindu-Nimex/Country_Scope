...
const CountryCard = ({ country, onSelect }) => (
  <div
    onClick={onSelect}
    className="rounded-xl shadow-md hover:shadow-xl cursor-pointer transition-all duration-300 transform hover:-translate-y-1 border border-lime-400 overflow-hidden"
  >
    ...
    <div className="p-4">
      ...
      <div className="mt-3 pt-3 border-t border-lime-400">
